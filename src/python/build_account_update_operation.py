...
from src.python.utils import EXAMPLE_PUBLIC_KEY, get_random_public_key, show_transaction, show_authority
...
async def create_account_update_operation() -> AccountAuthorityUpdateOperation:
    ...
    operation = await AccountAuthorityUpdateOperation.create_for(wax, account="alice")
